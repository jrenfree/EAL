function varargout = EAL_export(varargin)
% EAL_export MATLAB code for EAL_export.fig
%      EAL_export, by itself, creates a new EAL_export or raises the existing
%      singleton*.
%
%      H = EAL_export returns the handle to a new EAL_export or the handle to
%      the existing singleton*.
%
%      EAL_export('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in EAL_export.M with the given input arguments.
%
%      EAL_export('Property','Value',...) creates a new EAL_export or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before EAL_export_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to EAL_export_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help EAL_export

% Last Modified by GUIDE v2.5 16-Sep-2022 13:24:53

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @EAL_export_OpeningFcn, ...
    'gui_OutputFcn',  @EAL_export_OutputFcn, ...
    'gui_LayoutFcn',  @EAL_export_LayoutFcn, ...
    'gui_Callback',   []);
...
function EAL_export_OpeningFcn(hObject, ~, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to EAL_export (see VARARGIN)

% Choose default command line output for EAL_export
...
function varargout = EAL_export_OutputFcn(~, ~, handles)
...
%         drawnow expose update
    ...
    % close connection to ER60.
        ...
        % Stop timer that has EAL_export collect UDP ping data
...
if isnan(handles.depth)
    ...
    % If EAL_export was just started and hasn't detected a depth yet
...
% A depth was found
    ...
    % If EAL_export was just started, set flag to 0 in case it's missed next time
...
% Attempts to read a Settings.txt file various EAL_export parameters. If the files
...
function h1 = EAL_export_LayoutFcn(policy)
...
appdata.GUIDEOptions = struct(...
    ...
    'syscolorfig', 1, ...
    'blocking', 0, ...
    'lastSavedFile', 'C:\Users\josiah.renfree\Documents\Experiments\EAL\Matlab Scripts\Git\EAL_export.m', ...
    'lastFilename', 'C:\Users\josiah.renfree\Documents\Experiments\EAL\Matlab Scripts\EAL_20210320.fig');
appdata.lastValidTag = 'figure1';
appdata.GUIDELayoutEditor = mat{1};

h1 = figure(...
'Units','characters',...
'Position',[103.8 15.6153846153846 152.2 48.2307692307692],...
...
appdata = [];
appdata.lastValidTag = 'axesDepth';
...
'PlotBoxAspectRatio',[1 0.211981566820276 0.211981566820276],...
'PlotBoxAspectRatioMode',get(0,'defaultaxesPlotBoxAspectRatioMode'),...
'YDir','reverse',...
'YDirMode',get(0,'defaultaxesYDirMode'),...
'Colormap',[0 0 0.5625;0 0 0.625;0 0 0.6875;0 0 0.75;0 0 0.8125;0 0 0.875;0 0 0.9375;0 0 1;0 0.0625 1;0 0.125 1;0 0.1875 1;0 0.25 1;0 0.3125 1;0 0.375 1;0 0.4375 1;0 0.5 1;0 0.5625 1;0 0.625 1;0 0.6875 1;0 0.75 1;0 0.8125 1;0 0.875 1;0 0.9375 1;0 1 1;0.0625 1 1;0.125 1 0.9375;0.1875 1 0.875;0.25 1 0.8125;0.3125 1 0.75;0.375 1 0.6875;0.4375 1 0.625;0.5 1 0.5625;0.5625 1 0.5;0.625 1 0.4375;0.6875 1 0.375;0.75 1 0.3125;0.8125 1 0.25;0.875 1 0.1875;0.9375 1 0.125;1 1 0.0625;1 1 0;1 0.9375 0;1 0.875 0;1 0.8125 0;1 0.75 0;1 0.6875 0;1 0.625 0;1 0.5625 0;1 0.5 0;1 0.4375 0;1 0.375 0;1 0.3125 0;1 0.25 0;1 0.1875 0;1 0.125 0;1 0.0625 0;1 0 0;0.9375 0 0;0.875 0 0;0.8125 0 0;0.75 0 0;0.6875 0 0;0.625 0 0;0.5625 0 0],...
...
'Position',[85.2 38.7692307692308 62 5.38461538461539],...
'InnerPosition',[85.2 38.7692307692308 62 5.38461538461539],...
...
'LooseInset',[22.828 7.41230769230769 16.682 5.05384615384615],...
...
'Color',[0 0 0],...
'ColorMode','auto',...
'Position',[0.500001788688695 -0.0239130434782613 0.5],...
'PositionMode','auto',...
'String',blanks(0),...
'Interpreter','tex',...
'Rotation',0,...
...
'ColorMode','auto',...
'Position',[0.500000476837158 1.21376812034759 0],...
'PositionMode','auto',...
'String',blanks(0),...
'Interpreter','tex',...
'Rotation',0,...
...
'Color',[0.15 0.15 0.15],...
'ColorMode','auto',...
'Position',[-0.053763441903983 0.499999523162842 0],...
'PositionMode','auto',...
'String',blanks(0),...
'Interpreter','tex',...
'Rotation',90,...
...
appdata = [];
appdata.lastValidTag = 'axesSlope';
...
'ZRulerMode',get(0,'defaultaxesZRulerMode'),...
'AmbientLightSourceMode',get(0,'defaultaxesAmbientLightSourceMode'),...
'Position',[85.2 31.0769230769231 62 5.38461538461539],...
'InnerPosition',[85.2 31.0769230769231 62 5.38461538461539],...
'InnerPositionMode',get(0,'defaultaxesInnerPositionMode'),...
'ActivePositionProperty','position',...
'ActivePositionPropertyMode',get(0,'defaultaxesActivePositionPropertyMode'),...
'PositionConstraint','innerposition',...
...
'Color',[0 0 0],...
'ColorMode','auto',...
'Position',[0.500001788688695 1.02391304347826 0.5],...
'PositionMode','auto',...
'String',blanks(0),...
'Interpreter','tex',...
'Rotation',0,...
...
'Color',[0.15 0.15 0.15],...
'ColorMode','auto',...
'Position',[0.500000476837158 -0.213768120347589 0],...
'PositionMode','auto',...
'String',blanks(0),...
'Interpreter','tex',...
'Rotation',0,...
...
'Color',[0.15 0.15 0.15],...
'ColorMode','auto',...
'Position',[-0.053763441903983 0.500000476837159 0],...
'PositionMode','auto',...
'String',blanks(0),...
'Interpreter','tex',...
'Rotation',90,...
...
appdata = [];
appdata.lastValidTag = 'axesRoughness';
...
'CameraViewAngle',6.60861036031192,...
'CameraViewAngleMode',get(0,'defaultaxesCameraViewAngleMode'),...
'PlotBoxAspectRatio',[1 0.209677419354839 0.209677419354839],...
'PlotBoxAspectRatioMode',get(0,'defaultaxesPlotBoxAspectRatioMode'),...
'Colormap',[0 0 0.5625;0 0 0.625;0 0 0.6875;0 0 0.75;0 0 0.8125;0 0 0.875;0 0 0.9375;0 0 1;0 0.0625 1;0 0.125 1;0 0.1875 1;0 0.25 1;0 0.3125 1;0 0.375 1;0 0.4375 1;0 0.5 1;0 0.5625 1;0 0.625 1;0 0.6875 1;0 0.75 1;0 0.8125 1;0 0.875 1;0 0.9375 1;0 1 1;0.0625 1 1;0.125 1 0.9375;0.1875 1 0.875;0.25 1 0.8125;0.3125 1 0.75;0.375 1 0.6875;0.4375 1 0.625;0.5 1 0.5625;0.5625 1 0.5;0.625 1 0.4375;0.6875 1 0.375;0.75 1 0.3125;0.8125 1 0.25;0.875 1 0.1875;0.9375 1 0.125;1 1 0.0625;1 1 0;1 0.9375 0;1 0.875 0;1 0.8125 0;1 0.75 0;1 0.6875 0;1 0.625 0;1 0.5625 0;1 0.5 0;1 0.4375 0;1 0.375 0;1 0.3125 0;1 0.25 0;1 0.1875 0;1 0.125 0;1 0.0625 0;1 0 0;0.9375 0 0;0.875 0 0;0.8125 0 0;0.75 0 0;0.6875 0 0;0.625 0 0;0.5625 0 0],...
'ColormapMode',get(0,'defaultaxesColormapMode'),...
'Alphamap',[0 0.0159 0.0317 0.0476 0.0635 0.0794 0.0952 0.1111 0.127 0.1429 0.1587 0.1746 0.1905 0.2063 0.2222 0.2381 0.254 0.2698 0.2857 0.3016 0.3175 0.3333 0.3492 0.3651 0.381 0.3968 0.4127 0.4286 0.4444 0.4603 0.4762 0.4921 0.5079 0.5238 0.5397 0.5556 0.5714 0.5873 0.6032 0.619 0.6349 0.6508 0.6667 0.6825 0.6984 0.7143 0.7302 0.746 0.7619 0.7778 0.7937 0.8095 0.8254 0.8413 0.8571 0.873 0.8889 0.9048 0.9206 0.9365 0.9524 0.9683 0.9841 1],...
...
'ZRulerMode',get(0,'defaultaxesZRulerMode'),...
'AmbientLightSourceMode',get(0,'defaultaxesAmbientLightSourceMode'),...
'Position',[85.2 15.6923076923077 62 5.38461538461538],...
'InnerPosition',[85.2 15.6923076923077 62 5.38461538461538],...
'InnerPositionMode',get(0,'defaultaxesInnerPositionMode'),...
'ActivePositionProperty','position',...
'ActivePositionPropertyMode',get(0,'defaultaxesActivePositionPropertyMode'),...
'PositionConstraint','innerposition',...
...
'Color',[0 0 0],...
'ColorMode','auto',...
'Position',[0.500001788688695 1.02417582417582 0.5],...
'PositionMode','auto',...
'String',blanks(0),...
'Interpreter','tex',...
'Rotation',0,...
...
'Color',[0.15 0.15 0.15],...
'ColorMode','auto',...
'Position',[0.500000476837158 -0.216117220571189 0],...
'PositionMode','auto',...
'String',blanks(0),...
'Interpreter','tex',...
'Rotation',0,...
...
'ZRulerMode',get(0,'defaultaxesZRulerMode'),...
'AmbientLightSourceMode',get(0,'defaultaxesAmbientLightSourceMode'),...
'Position',[85.2 23.3846153846154 62 5.38461538461538],...
'InnerPosition',[85.2 23.3846153846154 62 5.38461538461538],...
'InnerPositionMode',get(0,'defaultaxesInnerPositionMode'),...
'ActivePositionProperty','position',...
'ActivePositionPropertyMode',get(0,'defaultaxesActivePositionPropertyMode'),...
'PositionConstraint','innerposition',...
...
'Tag','uipanel1',...
'Clipping','off',...
'Position',[4 20.2307692307692 63.6 26.9230769230769],...
'Layout',[],...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );

appdata = [];
appdata.lastValidTag = 'editDispRange';

h23 = uicontrol(...
'Parent',h22,...
'Units','characters',...
'FontUnits',get(0,'defaultuicontrolFontUnits'),...
'String','Unlock display range?',...
'Style','checkbox',...
'Position',[3.4 7.92307692307692 27.4 1.76923076923077],...
'Callback',@(hObject,eventdata)EAL_export('editDispRange_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'Tag','editDispRange',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );

appdata = [];
appdata.lastValidTag = 'setManualPI';

h24 = uicontrol(...
'Parent',h22,...
'Units','characters',...
'FontUnits',get(0,'defaultuicontrolFontUnits'),...
'String','Set Ping Interval',...
'Style','checkbox',...
'Position',[3.4 5.5384615384615 21.6 1.76923076923077],...
'Callback',@(hObject,eventdata)EAL_export('setManualPI_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'Enable','off',...
'Tag','setManualPI',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
...
'String',blanks(0),...
'Style','edit',...
'Position',[25 5.61538461538458 11.8 1.69230769230769],...
'BackgroundColor',[1 1 1],...
'Callback',@(hObject,eventdata)EAL_export('manualPI_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'Enable','off',...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)EAL_export('manualPI_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'Tag','manualPI');

appdata = [];
appdata.lastValidTag = 'manualPIButton';
...
'FontUnits',get(0,'defaultuicontrolFontUnits'),...
'String','Set',...
'Position',[38.8 5.5384615384615 5.8 1.76923076923077],...
'Callback',@(hObject,eventdata)EAL_export('manualPIButton_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'Enable','off',...
'Tag','manualPIButton',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
...
appdata = [];
appdata.lastValidTag = 'checkboxCheckDeepBottom';

h27 = uicontrol(...
'Parent',h22,...
'Units','characters',...
'FontUnits',get(0,'defaultuicontrolFontUnits'),...
'String','Check Deep Bottom?',...
'Style','checkbox',...
'Position',[3.4 12.3076923076923 26.2 1.76923076923077],...
'Callback',@(hObject,eventdata)EAL_export('checkboxCheckDeepBottom_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'Tag','checkboxCheckDeepBottom',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );

appdata = [];
appdata.lastValidTag = 'buttonCheckBottomNow';
...
'String','Check now',...
'Style','togglebutton',...
'Position',[28.4 12.3076923076923 14 1.76923076923077],...
'Callback',@(hObject,eventdata)EAL_export('buttonCheckBottomNow_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'Tag','buttonCheckBottomNow',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
...
'Units','characters',...
'FontUnits',get(0,'defaultuicontrolFontUnits'),...
'String','Next detection:',...
'Style','text',...
'Position',[12 10.4615384615384 15 1.15384615384615],...
'Children',[],...
'Tag','text48',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );

appdata = [];
appdata.lastValidTag = 'nextBottomCheck';
...
'String',blanks(0),...
'Style','edit',...
'Position',[28.4 10.3076923076923 25.4 1.53846153846154],...
'BackgroundColor',[1 1 1],...
'Callback',@(hObject,eventdata)EAL_export('nextBottomCheck_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'Enable','off',...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)EAL_export('nextBottomCheck_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'Tag','nextBottomCheck');

appdata = [];
appdata.lastValidTag = 'fixFB';

h31 = uicontrol(...
'Parent',h22,...
'Units','characters',...
'FontUnits',get(0,'defaultuicontrolFontUnits'),...
'String','Correct false bottom?',...
'Style','checkbox',...
'Position',[3.4 19.3846153846154 27 1.76923076923077],...
'Callback',@(hObject,eventdata)EAL_export('fixFB_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'Tag','fixFB',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );

appdata = [];
appdata.lastValidTag = 'FBCorrected';
...
'String',blanks(0),...
'Style','edit',...
'Position',[29.4 19.4615384615385 31.4 1.69230769230769],...
'BackgroundColor',[1 1 1],...
'Callback',@(hObject,eventdata)EAL_export('FBCorrected_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'Enable','off',...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)EAL_export('FBCorrected_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'Tag','FBCorrected');
...
'Style','text',...
'Position',[13.8 17.3846153846154 15.6 1.15384615384615],...
'Children',[],...
'Tag','text38',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );

appdata = [];
appdata.lastValidTag = 'bathyFile';
...
'String',blanks(0),...
'Style','edit',...
'Position',[32 17.1538461538461 23 1.69230769230769],...
'BackgroundColor',[1 1 1],...
'Callback',@(hObject,eventdata)EAL_export('bathyFile_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'Enable','off',...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)EAL_export('bathyFile_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'Tag','bathyFile');

appdata = [];
appdata.lastValidTag = 'bathyFileBrowse';
...
'FontUnits',get(0,'defaultuicontrolFontUnits'),...
'String','...',...
'Position',[56.4 17.1538461538461 4.4 1.69230769230769],...
'Callback',@(hObject,eventdata)EAL_export('bathyFileBrowse_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'Enable','off',...
'Tag','bathyFileBrowse',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
...
appdata = [];
appdata.lastValidTag = 'loadBathy';
...
'FontUnits',get(0,'defaultuicontrolFontUnits'),...
'String','Load',...
'Position',[13.8 14.4615384615384 10 2.23076923076923],...
'Callback',@(hObject,eventdata)EAL_export('loadBathy_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'Enable','off',...
'Tag','loadBathy',...
'FontSize',12,...
...
appdata = [];
appdata.lastValidTag = 'bathyLoadStatus';

h37 = uicontrol(...
'Parent',h22,...
'Units','characters',...
'FontUnits',get(0,'defaultuicontrolFontUnits'),...
'String','No bathymetry data loaded!',...
'Style','edit',...
'Position',[25.6 14.6153846153846 35.2 2],...
'Children',[],...
'Enable','off',...
'Tag','bathyLoadStatus',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
...
appdata = [];
appdata.lastValidTag = 'checkboxNoise';

h38 = uicontrol(...
'Parent',h22,...
'Units','characters',...
'FontUnits',get(0,'defaultuicontrolFontUnits'),...
'String','Measure noise?',...
'Style','checkbox',...
'Position',[3.4 21.5384615384615 21.6 1.76923076923077],...
'Children',[],...
'Tag','checkboxNoise',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );

appdata = [];
appdata.lastValidTag = 'checkboxKSync';
...
'String','K-Sync?',...
'Style','checkbox',...
'Position',[3.4 3.15384615384614 14 1.76923076923077],...
'Callback',@(hObject,eventdata)EAL_export('checkboxKSync_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'Tag','checkboxKSync',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );

appdata = [];
appdata.lastValidTag = 'checkboxME70';
...
'String','ME70?',...
'Style','checkbox',...
'Position',[3.4 0.923076923076914 11.8 1.76923076923077],...
'Callback',@(hObject,eventdata)EAL_export('checkboxME70_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'Tag','checkboxME70',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
...
'String','IP Address:',...
'Style','text',...
'Position',[18.6 1.23076923076923 11.6 1.15384615384615],...
'Children',[],...
'Tag','text57',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );

appdata = [];
appdata.lastValidTag = 'ME70IPAddress';
...
'String',blanks(0),...
'Style','edit',...
'Position',[34 1.07692307692307 20.2 1.53846153846154],...
'BackgroundColor',[1 1 1],...
'Callback',@(hObject,eventdata)EAL_export('ME70IPAddress_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'Enable','off',...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)EAL_export('ME70IPAddress_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'Tag','ME70IPAddress');

appdata = [];
appdata.lastValidTag = 'softwarePulldown';
...
'Style','popupmenu',...
'Value',1,...
'Position',[15.2 23.6153846153846 13 1.53846153846154],...
'BackgroundColor',[1 1 1],...
'Callback',@(hObject,eventdata)EAL_export('softwarePulldown_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)EAL_export('softwarePulldown_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'Tag','softwarePulldown');
...
'String','Software:',...
'Style','text',...
'Position',[3.4 23.6923076923077 10.2 1.15384615384615],...
'Children',[],...
'Tag','text58',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
...
'Tag','uipanel2',...
'Clipping','off',...
'Position',[4 4.07692307692308 63.6 15.6153846153846],...
'Layout',[],...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
...
'String','Depth (m):',...
'Style','text',...
'Position',[2.6 11.2538461538462 22.2 2.15384615384615],...
'Children',[],...
'Tag','text8',...
'FontSize',16,...
'FontWeight','bold',...
...
'FontUnits',get(0,'defaultuicontrolFontUnits'),...
'HorizontalAlignment','left',...
'String','Ping Interval (s):',...
'Style','text',...
'Position',[2.6 4.63846153846156 34.6 2.15384615384615],...
'Children',[],...
'Tag','text14',...
'FontSize',16,...
'FontWeight','bold',...
...
'FontUnits',get(0,'defaultuicontrolFontUnits'),...
'HorizontalAlignment','left',...
'String','Logging Depth (m):',...
'Style','text',...
'Position',[2.6 7.94615384615387 42 2.15384615384615],...
'Children',[],...
'Tag','text15',...
'FontSize',16,...
'FontWeight','bold',...
...
appdata = [];
appdata.lastValidTag = 'pInterval';
...
'FontUnits',get(0,'defaultuicontrolFontUnits'),...
'Style','edit',...
'Position',[43.4 4.40769230769232 16 2.5],...
'BackgroundColor',[1 1 1],...
'Callback',@(hObject,eventdata)EAL_export('pInterval_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'Enable','off',...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)EAL_export('pInterval_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'Tag','pInterval',...
'UserData',[],...
'FontSize',12);

appdata = [];
appdata.lastValidTag = 'lRange';
...
'String',blanks(0),...
'Style','edit',...
'Position',[43.4 7.71538461538464 16 2.5],...
'BackgroundColor',[1 1 1],...
'Callback',@(hObject,eventdata)EAL_export('lRange_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'Enable','off',...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)EAL_export('lRange_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'Tag','lRange',...
'FontSize',12);

appdata = [];
appdata.lastValidTag = 'Depth';
...
'String',blanks(0),...
'Style','edit',...
'Position',[43.4000000000001 11.0230769230769 16 2.5],...
'Callback',@(hObject,eventdata)EAL_export('Depth_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'ForegroundColor',[0.501960784313725 0.501960784313725 0.501960784313725],...
'Enable','inactive',...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)EAL_export('Depth_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'Tag','Depth',...
'FontSize',12);
...
'String','Ping Time:',...
'Style','text',...
'Position',[2.6 1.40769230769232 22.4 2.15384615384615],...
'Children',[],...
'Tag','text42',...
'FontSize',16,...
'FontWeight','bold',...
...
'String',blanks(0),...
'Style','edit',...
'Position',[26.2 1.17692307692308 33.2 2.53846153846154],...
'BackgroundColor',[1 1 1],...
'Callback',@(hObject,eventdata)EAL_export('pingTime_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'Enable','off',...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)EAL_export('pingTime_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'Tag','pingTime',...
'FontSize',12);
...
'String','START',...
'Style','togglebutton',...
'Position',[97.6 5.07692307692309 31.8 4.07692307692308],...
'BackgroundColor',[0 1 0],...
'Callback',@(hObject,eventdata)EAL_export('startButton_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'Tag','startButton',...
'FontSize',20,...
'FontWeight','bold',...
...
appdata = [];
appdata.lastValidTag = 'restartTest';
...
'String',blanks(0),...
'Style','edit',...
'Position',[79.8 1.23076923076924 67.2 2.23076923076923],...
'BackgroundColor',[1 1 1],...
'Callback',@(hObject,eventdata)EAL_export('restartTest_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)EAL_export('restartTest_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'Tag','restartTest');
...
'Position',[26 1 19.8 2],...
'Callback',@(hObject,eventdata)EAL_export('buttonSettings_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'Tag','buttonSettings',...
'FontSize',10,...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
...
elseif local_isInvokeHGCallback(gui_State, varargin{:})
    % EAL_EXPORT('CALLBACK',hObject,eventData,handles,...)
    gui_Create = false;
else
    % EAL_EXPORT(...)
